...
/**
 * A `var(--mb-color-...)` CSS variable reference (see `ColorName` in
 * `metabase/ui/colors/types` for the available keys) or any CSS color string.
 *
 * @inline
 */
export type ColorCssVariableOrString = `var(--mb-color-${string})` | string;
...
/**
 * Embed-setup-wizard-scoped theme: either an inline MetabaseTheme or a
 * reference to a saved EmbeddingTheme via `id`. The preview resolves `id`
 * back to an inline theme before handing it to embed.js.
 */
